...
class searchForm(Form):
        choices = [('LA County', 'LA County'),('Issue', 'Issue'), ('LA Committees', 'LA Committees'), ('Orange County', 'Orange County'),('San Diego County', 'San Diego County'), ('Long Beach Committees', 'Long Beach Committees')]
